																...
																<div class="form-group row">
																	...
																	<div class="col-sm-6">
																		<input class="form-control" placeholder="Descricao"
																			type="text" name="recurso.descricao" value="${recurso.descricao}">
																	</div>
																</div>
																	...
																	<div class="col-sm-6">
																		<select class="form-control" name="recurso.setor.id">
																			<c:forEach items="${setores}" var="setor">
																				<option value="${setor.id}" <c:if test="${setor.id == recurso.setor.id}">selected</c:if>>${setor.descricao}</option>
																			</c:forEach>
																		</select>
																	</div>
																</div>
