            ...
            <form class="form-horizontal" action="<c:url value='/unidades/${unidadeMedida.id}'/>"
              ...
              <div class="box-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="descricao" placeholder="Descrição" name="unidade.descricao" value="${unidadeMedida.descricao}" required="required">
                  </div>
                </div>
                <div class="form-group row">
                  ...
                  <div class="col-sm-3">
                    <input type="text" class="form-control" id="sigla" placeholder="Sigla" name="unidade.sigla" value="${unidadeMedida.sigla}" required="required">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
