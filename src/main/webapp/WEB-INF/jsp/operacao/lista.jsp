					...
					<div class="row">
						...
						<div class="col s12">
							<div id="data-table-simple_wrapper" class="dataTables_wrapper">
								<div class="dataTables_length" id="data-table-simple_length">
									<label>Show
										<div class="select-wrapper initialized">
											<span class="caret">▼</span><input class="select-dropdown"
												readonly="true"
												data-activates="select-options-652d4a42-0c1d-501d-b8a2-b28ad835c1a1"
												value="10" type="text">
											<ul id="select-options-652d4a42-0c1d-501d-b8a2-b28ad835c1a1"
												class="dropdown-content select-dropdown ">
												<li class=""><span>10</span></li>
												<li class=""><span>25</span></li>
												<li class=""><span>50</span></li>
												<li class=""><span>100</span></li>
											</ul>
											<select name="data-table-simple_length"
												aria-controls="data-table-simple" class="initialized"><option
													value="10">10</option>
								...
								<div id="data-table-simple_filter" class="dataTables_filter">
									<label>Search:<input class="" placeholder=""
										aria-controls="data-table-simple" type="search"></label>
								</div>
								<table id="data-table-simple"
									class="responsive-table display dataTable" role="grid"
									aria-describedby="data-table-simple_info" cellspacing="0">
									<thead>
										<tr role="row">
											...
											<th class="sorting" tabindex="0"
												aria-controls="data-table-simple" rowspan="1" colspan="1"
												style="width: 324px;"
												aria-label="Position: activate to sort column ascending">Setor</th>
											<th class="sorting" tabindex="0"
												aria-controls="data-table-simple" rowspan="1" colspan="1"
												style="width: 150px;"
								...
								<div class="dataTables_info" id="data-table-simple_info"
								...
								<div class="dataTables_paginate paging_simple_numbers"
									...
									<a class="paginate_button previous disabled"
										...
										aria-controls="data-table-simple" data-dt-idx="1" tabindex="0">1</a><a
										class="paginate_button " aria-controls="data-table-simple"
										data-dt-idx="2" tabindex="0">2</a><a class="paginate_button "
										aria-controls="data-table-simple" data-dt-idx="3" tabindex="0">3</a><a
										class="paginate_button " aria-controls="data-table-simple"
										data-dt-idx="4" tabindex="0">4</a><a class="paginate_button "
										aria-controls="data-table-simple" data-dt-idx="5" tabindex="0">5</a><a
										class="paginate_button " aria-controls="data-table-simple"
